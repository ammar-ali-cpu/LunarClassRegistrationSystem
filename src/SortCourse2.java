...
public class SortCourse2 extends JFrame
{
    ...
    SortCourse2(HashMap<String, String> logIns, HashMap<String, Student> database, String webID, ArrayList<Course> courses)
    {
        signIns = logIns;
        ...
        this.setTitle("Sorting by Course Name");
